            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/icon.png" height="90" width="94" alt="Footer logo"> </a> <span>Enjoy Refreshing Breakfast </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-3 how-it-works-links color-gray">
                        <h5>How it Works</h5>
                        <ul>
                            <li><a href="index.php">Enter your location</a> </li>
                            <li><a href="subscribe.php">Choose Subscription</a> </li>
                            <li><a href="#">Pay</a> </li>
